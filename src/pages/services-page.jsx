        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {services.map((service, index) => (
              <div 
                key={service.id} 
                className="group bg-white/70 backdrop-blur-sm rounded-2xl border border-white/60 p-8 hover-float animate-fade-in transition-all duration-500 hover:bg-white/90 hover:shadow-2xl hover:border-[color:var(--color-primary)]/20"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                {/* Premium Icon Container */}
                <div className="w-20 h-20 bg-gradient-to-br from-[color:var(--color-primary)] to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                  {service.icon ? (
                    <img 
                      src={service.icon} 
                      alt={service.title}
                ...
                <div className="text-center">
                  <h3 className="text-2xl font-bold text-[color:var(--color-text-dark)] mb-4 group-hover:text-[color:var(--color-primary)] transition-colors">
                    {service.title}
                  </h3>
                  <p className="text-[color:var(--color-text-light)] mb-8 leading-relaxed line-clamp-3">
                    {service.description}
                  </p>

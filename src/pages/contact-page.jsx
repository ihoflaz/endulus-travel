...
const ContactPage = () => {
  ...
  useEffect(() => {
    setIsVisible(true);
    document.title = 'İletişim - Endülüs Travel';
  }, []);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-white animate-fade-in">
              <div className="inline-flex items-center px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-8">
                ...
                <span className="text-sm font-medium">Şimdi Çevrimiçiyiz</span>
              </div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed max-w-lg">
                Hayalinizdeki seyahati planlamak için buradayız. Premium seyahat deneyimleri için bizimle iletişime geçin.
              </p>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-blue-200">Değerlendirme</div>
                </div>
                <div className="text-center">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-green-100 text-sm">Anında Mesaj</div>
                  </div>
                </a>
              </div>
            </div>
            ...
            <div className="animate-fade-in" style={{ animationDelay: '0.3s' }}>
              <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-white mb-2">Hemen İletişime Geçin</h2>
                  <p className="text-blue-200">Size özel teklif hazırlayalım</p>
                </div>
                ...
                {submitStatus === 'success' && (
                  <div className="mb-6 p-4 bg-green-500/20 border border-green-400/30 rounded-2xl backdrop-blur-sm animate-fade-in">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-green-100 font-semibold">Mesajınız başarıyla gönderildi!</p>
                        <p className="text-green-200 text-sm">24 saat içinde size dönüş yapacağız.</p>
                      </div>
                    </div>
                  </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      >
                        <option value="" className="bg-slate-800">Konu seçiniz</option>
                        ...
                        <option value="ozel-tur" className="bg-slate-800">Özel Tur Talebi</option>
                        <option value="grup-tur" className="bg-slate-800">Grup Turu</option>
                        <option value="iptal-degisiklik" className="bg-slate-800">İptal/Değişiklik</option>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Hangi destinasyonlara ilgi duyuyorsunuz? Seyahat tarihleriniz ve grup büyüklüğünüz nedir?"
                    ></textarea>
                    {errors.message && (
                      <p className="mt-2 text-sm text-red-300 flex items-center">
                        <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Profesyonel ekibimiz size en iyi seyahat deneyimini sunmak için burada
            </p>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl border border-slate-100">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-4 bg-blue-50 rounded-2xl p-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-600 text-sm">Kadıköy'ün kalbinde, ulaşım kolaylığı</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-slate-100 to-blue-50 rounded-2xl p-8">
                <h4 className="text-xl font-bold text-slate-800 mb-6">Çalışma Saatleri</h4>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center py-3">
                    ...
                    <span className="text-red-500 font-semibold">Kapalı</span>
                  </div>
                </div>
                ...
                <div className="mt-6 p-4 bg-green-100 rounded-xl">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-green-800 font-semibold">Şu anda açığız!</span>
                  </div>
                  <p className="text-green-700 text-sm mt-1">Acil durumlar için 7/24 WhatsApp destek</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-8">
              <div className="w-2 h-2 bg-green-400 rounded-full mr-3 animate-pulse"></div>
              <span className="text-white font-semibold">Özel Teklifler Mevcut</span>
            </div>
            ...
            <p className="text-xl text-blue-100 mb-12 leading-relaxed max-w-3xl mx-auto">
              Profesyonel ekibimiz ile size özel, unutulmaz seyahat deneyimleri yaşayın. 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Hızlı Yanıt</h3>
                <p className="text-blue-200">24 saat içinde detaylı teklif</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Ücretsiz Danışmanlık</h3>
                <p className="text-blue-200">İlk görüşme tamamen ücretsiz</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Kişisel Tasarım</h3>
                <p className="text-blue-200">Size özel tur planlaması</p>
              </div>
            </div>

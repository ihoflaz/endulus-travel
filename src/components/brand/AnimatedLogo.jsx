...
const AnimatedLogo = ({ size = 40, variant = 'gold', withWordmark = true, className = '', animate = true }) => {
  ...
  return (
    <span className={`inline-flex items-center gap-3 ${className}`} aria-label="Endülüs Travel">
      <motion.svg
        width={size}
        height={size}
        ...
        role="img"
        aria-hidden
        initial={animate ? { opacity: 0, scale: 0.7, rotate: -8 } : false}
